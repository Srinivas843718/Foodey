...
const Home = () => {
    ...
    return (<>
        <div>
            ...
            <div className="py-5" style={{backgroundImage: `url("http://wallpapersdsc.net/wp-content/uploads/2016/09/Food-HD-Background.png")`,backgroundRepeat: 'no-repeat',backgroundSize:'cover'}}>
                ...
                {item.map((data) => (
                    <>
                        <div className="col-4 ">
                            ...
                            <div class="  card shadow m-4" style={{ width: "15rem" }}>
                                <img class="card-img-top" width="250" height="150" src={data.image} alt="Card image cap" />
                                <div class="card-body">
                                    <strong class="card-title" >{data.type}</strong>
                                    </div>
                                    </div>
                                </div>
            ...
            <h1 className="display-3 text-center text-warning mt-5 mb-5" >HOW TO ORDER ?</h1> 
...
<div className="row ">
         ...
         <div className="row" style={{marginLeft:"780px"}}>
             <div className="col-1">
